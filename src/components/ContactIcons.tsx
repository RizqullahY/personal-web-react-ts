...
const MOCKDATA = [
  { title: "Email", description: "rizqullahyusufrafly@gmail.com", icon: At },
  { title: "Github", description: "rizqullahy", icon: BrandGithub },
  { title: "Address", description: "Trenggalek, Jawa Timur", icon: MapPin },
